OptiPrice - Track product prices across e-commerce sites and get alerts on price drops. Built with Next.js, Firecrawl, and Supabase.
...
- 🔄 **Automated Daily Checks** - Scheduled cron jobs daily check prices automatically every 30 minutes
